...
const writingExampleRows = [
  {
    level: "A1",
    title: "Kurze Nachricht: Deutschkurs",
  ...
  {
    level: "A1",
    title: "Kurze Nachricht: Einladung",
    format: "Anrede · Einladung · Zeit/Ort · Gruß",
    task: "Sie laden einen Freund zum Essen ein. Schreiben Sie: Tag, Uhrzeit, Ort.",
    sample: "Hallo Tom,\n\nich mache am Freitag ein Abendessen. Kommst du um 19 Uhr zu mir? Meine Adresse ist Parkstraße 8. Bitte bring etwas zu trinken mit.\n\nViele Grüße\nAnna",
    note: "約 30-40 Wörter",
  },
  {
    level: "A1",
    title: "Formularangaben",
    format: "vollständige Angaben · kurze Antwort",
    task: "Sie melden sich für einen Kurs an. Schreiben Sie kurze Angaben zu Name, Wohnort, Sprache und Kurszeit.",
    sample: "Name: Anna Schmidt\nWohnort: Berlin\nSprache: Deutsch\nKurs: A1 am Montag und Mittwoch\n\nIch möchte am Abend lernen, weil ich am Tag arbeite.",
    note: "約 25-35 Wörter",
  },
  {
    level: "A1",
    title: "Kurze E-Mail: Termin",
    format: "formelle Anrede · Bitte · Termin · Gruß",
    task: "Sie möchten einen Termin in der Arztpraxis. Schreiben Sie: Problem, Wunsch, Telefonnummer.",
    sample: "Sehr geehrte Damen und Herren,\n\nich habe Kopfschmerzen und brauche einen Termin. Kann ich am Dienstag kommen? Meine Telefonnummer ist 0912 345 678.\n\nMit freundlichen Grüßen\nAnna Schmidt",
    note: "約 35-45 Wörter",
  },
  {
    level: "A2",
    title: "Private E-Mail: Lernen",
  ...
  {
    level: "A2",
    title: "Private E-Mail: Reise",
    format: "Anrede · Vergangenheit · Plan · Frage · Schluss",
    task: "Sie waren am Wochenende in einer anderen Stadt. Schreiben Sie an eine Freundin: wohin Sie gefahren sind, was Sie gemacht haben, warum es schön war.",
    sample: "Liebe Emma,\n\nam Wochenende war ich in Hamburg. Ich bin mit dem Zug gefahren und habe dort meine Tante besucht. Am Samstag sind wir durch die Stadt gegangen und haben den Hafen gesehen. Das Wetter war windig, aber sehr angenehm. Besonders schön fand ich die Bootsfahrt, weil man die Stadt vom Wasser aus sehen konnte. Am Abend haben wir in einem kleinen Restaurant gegessen.\n\nMöchtest du beim nächsten Mal mitkommen? Dann können wir zusammen ein Zimmer buchen.\n\nLiebe Grüße\nAnna",
    note: "約 85-105 Wörter",
  },
  {
    level: "A2",
    title: "Halbformelle E-Mail: Termin ändern",
    format: "Anrede · Grund · neuer Vorschlag · Bitte · Gruß",
    task: "Sie können zu einem Termin nicht kommen. Schreiben Sie an die Sprachschule: Grund, neuer Termin, Bitte um Antwort.",
    sample: "Sehr geehrte Frau Keller,\n\nleider kann ich am Mittwoch nicht zum Beratungstermin kommen, weil ich länger arbeiten muss. Es tut mir leid. Können wir den Termin bitte verschieben? Ich habe am Freitag ab 10 Uhr oder am Montag am Nachmittag Zeit. Bitte schreiben Sie mir kurz, welcher Termin möglich ist.\n\nVielen Dank für Ihre Hilfe.\n\nMit freundlichen Grüßen\nAnna Schmidt",
    note: "約 75-95 Wörter",
  },
  {
    level: "A2",
    title: "Private Nachricht: Hilfe",
    format: "Situation · Bitte · Zeit/Ort · Dank",
    task: "Sie ziehen um und brauchen Hilfe. Schreiben Sie an einen Freund: wann, wobei, was danach passiert.",
    sample: "Lieber David,\n\nich ziehe nächste Woche in eine neue Wohnung um und brauche Hilfe. Kannst du am Samstag um 10 Uhr kommen? Wir müssen einige Kartons tragen und ein Regal aufbauen. Die Wohnung ist in der Nähe vom Bahnhof, also kommst du gut mit dem Bus dorthin. Nach der Arbeit bestelle ich Pizza für alle.\n\nVielen Dank und bis bald!\nAnna",
    note: "約 75-90 Wörter",
  },
  {
    level: "B1",
    title: "Private E-Mail: Feier",
  ...
  {
    level: "B1",
    title: "Forumsbeitrag: Online-Unterricht",
    format: "Meinung · Erfahrung · Begründung · Schluss",
    task: "Schreiben Sie einen Forumsbeitrag zum Thema Online-Unterricht. Nennen Sie Ihre Meinung, eine Erfahrung und einen Tipp.",
    sample: "Ich finde Online-Unterricht praktisch, wenn man wenig Zeit hat oder weit von der Schule entfernt wohnt. Während der Pandemie habe ich selbst mehrere Monate online gelernt. Am Anfang war es schwierig, weil ich mich zu Hause leicht ablenken ließ. Später habe ich gemerkt, dass feste Lernzeiten und ein ruhiger Arbeitsplatz sehr wichtig sind.\n\nEin Vorteil ist, dass man keine Zeit für den Weg verliert. Außerdem kann man Materialien schnell teilen und Übungen direkt am Computer machen. Trotzdem fehlt mir manchmal der persönliche Kontakt zu anderen Lernenden. Deshalb sollte Online-Unterricht gut organisiert sein und nicht nur aus langen Vorträgen bestehen.\n\nMein Tipp ist: Kamera einschalten, aktiv Fragen stellen und nach dem Kurs kurze Notizen schreiben. Dann lernt man auch online effektiv.",
    note: "約 130-160 Wörter",
  },
  {
    level: "B1",
    title: "Formelle E-Mail: Beschwerde",
    format: "Anrede · Problem · Folgen · Wunsch · Gruß",
    task: "Sie haben ein Zimmer im Hotel gebucht, aber es war laut und nicht sauber. Schreiben Sie eine Beschwerde.",
    sample: "Sehr geehrte Damen und Herren,\n\nvom 12. bis 14. Mai habe ich in Ihrem Hotel übernachtet. Leider war ich mit dem Zimmer nicht zufrieden. Das Bad war nicht sauber, und nachts war es sehr laut, weil mein Zimmer direkt neben dem Aufzug lag. Deshalb konnte ich schlecht schlafen. Außerdem funktionierte das WLAN nur manchmal, obwohl es in der Beschreibung kostenloses Internet geben sollte.\n\nIch habe an der Rezeption Bescheid gesagt, aber das Problem wurde nicht gelöst. Deshalb bitte ich Sie um eine teilweise Rückerstattung oder einen Gutschein für eine nächste Buchung. Ich hoffe, dass Sie meine Beschwerde prüfen und mir bald antworten.\n\nMit freundlichen Grüßen\nAnna Schmidt",
    note: "約 130-160 Wörter",
  },
  {
    level: "B1",
    title: "Private E-Mail: Kurswechsel",
    format: "Situation · Grund · Bitte um Rat · Vorschlag",
    task: "Sie möchten den Deutschkurs wechseln. Schreiben Sie an einen Freund: warum, welcher Kurs besser passt, was Sie wissen möchten.",
    sample: "Lieber Tom,\n\nich überlege, meinen Deutschkurs zu wechseln. Der aktuelle Kurs ist zwar interessant, aber er findet immer am Abend statt. Nach der Arbeit bin ich oft müde und kann mich nicht gut konzentrieren. Außerdem sprechen wir im Kurs wenig, obwohl ich gerade beim Sprechen mehr Übung brauche.\n\nIch habe einen anderen Kurs gefunden, der am Samstagvormittag stattfindet. Dort gibt es kleinere Gruppen und mehr Prüfungstraining. Das klingt für mich sehr passend. Du hast doch schon einmal einen Kurs an dieser Schule besucht. Kannst du mir sagen, ob die Lehrer dort gut erklären? Vielleicht können wir am Wochenende darüber sprechen.\n\nLiebe Grüße\nAnna",
    note: "約 125-150 Wörter",
  },
  {
    level: "B2",
    title: "Forumsbeitrag: Plastikverpackungen",
  ...
  },
  {
    ...
    format: "Einleitung · Pro/Contra · Beispiele · Fazit",
    task: "Schreiben Sie einen Forumsbeitrag zum Thema Homeoffice. Nennen Sie Vorteile, Nachteile und Ihre persönliche Einschätzung.",
    sample: "Seit einigen Jahren arbeiten immer mehr Menschen zumindest teilweise im Homeoffice. Ich halte diese Entwicklung grundsätzlich für positiv, weil sie vielen Beschäftigten mehr Flexibilität ermöglicht. Wer zu Hause arbeitet, spart den Arbeitsweg und kann seine Zeit oft besser einteilen. Das ist besonders für Menschen hilfreich, die Familie und Beruf miteinander vereinbaren müssen.\n\nGleichzeitig darf man die Nachteile nicht unterschätzen. Wenn Kolleginnen und Kollegen sich selten persönlich sehen, kann die Kommunikation schwieriger werden. Manche Informationen gehen verloren, weil sie nur in Chats oder kurzen E-Mails stehen. Außerdem fällt es einigen Menschen schwer, nach Feierabend wirklich abzuschalten, wenn Arbeitsplatz und Privatleben im selben Raum stattfinden.\n\nMeiner Meinung nach ist ein hybrides Modell am sinnvollsten. Zwei oder drei Tage im Büro fördern den Austausch im Team, während Homeoffice-Tage konzentriertes Arbeiten erleichtern. Entscheidend ist, dass Unternehmen klare Regeln für Erreichbarkeit, Dokumentation und Pausen festlegen. Nur dann wird Homeoffice nicht zur Belastung, sondern zu einer echten Verbesserung der Arbeitskultur.",
    note: "約 190-230 Wörter",
  },
  {
    level: "B2",
    title: "Formelle Nachricht: Kursproblem",
    format: "Anrede · Anlass · Problem · Erwartung · höflicher Schluss",
    task: "Sie haben an einem Onlinekurs teilgenommen, der nicht wie beschrieben war. Schreiben Sie an den Anbieter und bitten Sie um eine Lösung.",
    sample: "Sehr geehrte Damen und Herren,\n\nich habe vom 3. bis 28. April an Ihrem Onlinekurs zur Prüfungsvorbereitung B2 teilgenommen. Leider entsprach der Kurs nicht der Beschreibung auf Ihrer Webseite. Dort wurde angekündigt, dass jede Woche individuelles Feedback zu schriftlichen Aufgaben gegeben wird. Tatsächlich haben wir jedoch nur allgemeine Lösungen erhalten, ohne konkrete Hinweise zu unseren Texten.\n\nFür mich war das besonders problematisch, weil ich den Kurs vor allem wegen des Schreibtrainings gebucht habe. Außerdem fiel eine Unterrichtsstunde aus, ohne dass ein Ersatztermin angeboten wurde. Ich verstehe, dass technische oder organisatorische Probleme vorkommen können. Trotzdem erwarte ich bei einem kostenpflichtigen Kurs eine transparente Information und eine angemessene Lösung.\n\nIch bitte Sie daher, mir entweder einen zusätzlichen Feedbacktermin anzubieten oder einen Teil der Kursgebühr zu erstatten. Über eine Antwort innerhalb der nächsten Woche würde ich mich freuen.\n\nMit freundlichen Grüßen\nAnna Schmidt",
    note: "約 180-220 Wörter",
  },
  {
    level: "B2",
    title: "Forumsbeitrag: Öffentliche Verkehrsmittel",
    format: "Meinung · Gründe · Maßnahmen · Fazit",
    task: "Schreiben Sie einen Forumsbeitrag: Sollten öffentliche Verkehrsmittel günstiger sein? Begründen Sie Ihre Meinung und nennen Sie mögliche Folgen.",
    sample: "Die Frage, ob öffentliche Verkehrsmittel günstiger sein sollten, wird in vielen Städten diskutiert. Aus meiner Sicht wäre eine deutliche Senkung der Preise sinnvoll, weil sie sowohl soziale als auch ökologische Vorteile hätte. Menschen mit geringem Einkommen könnten leichter am öffentlichen Leben teilnehmen, und gleichzeitig würden mehr Personen Bus und Bahn statt des Autos nutzen.\n\nAllerdings reicht ein niedriger Preis allein nicht aus. Wenn Züge unpünktlich sind oder Busse nur selten fahren, steigen viele Menschen trotzdem nicht um. Deshalb müssten günstigere Tickets mit Investitionen in ein besseres Angebot verbunden werden. Besonders wichtig wären dichtere Verbindungen am Abend, saubere Fahrzeuge und sichere Bahnhöfe.\n\nNatürlich stellt sich die Frage der Finanzierung. Meiner Meinung nach sollte der Staat öffentliche Mobilität stärker unterstützen, weil sie eine Grundversorgung ist. Langfristig könnten weniger Staus, bessere Luft und eine höhere Lebensqualität die Kosten rechtfertigen. Deshalb bin ich dafür, öffentliche Verkehrsmittel bezahlbarer zu machen, aber nur zusammen mit einem zuverlässigen Ausbau.",
    note: "約 180-220 Wörter",
  },
];
...
const b2LessonPlans = [
  ...
  },
  {
    ...
    vocab: [["die Mietbelastung", "租金負擔", "die Mietbelastungen"], ["das Quartier", "街區；社區", "die Quartiere"], ["die Stadtplanerin", "都市規劃師", "die Stadtplanerinnen"], ["die Aufwertung", "升級；價值提升", "die Aufwertungen"], ["die Verdrängung", "排擠", "die Verdrängungen"], ["die Renovierung", "翻修", "die Renovierungen"], ["der Verlust", "喪失", "die Verluste"], ["die Vielfalt", "多樣性", "-"], ["die Maßnahme", "措施", "die Maßnahmen"], ["die Mietbegrenzung", "租金限制", "die Mietbegrenzungen"], ["nachgefragt", "需求高的", ""], ["leistbar", "可負擔的", ""], ["sanierungsbedürftig", "需要修繕的", ""], ["genossenschaftlich", "合作社式的", ""], ["absichern", "保障", ""], ["sich vollziehen", "逐步發生", ""]],
  ...
  },
  {
    ...
    extraVocab: [["liegen bleiben", "被擱置", ""], ["die Kundschaft", "顧客群", "-"], ["über einen Zeitraum von sechs Monaten", "在六個月期間", ""], ["Rückmeldung geben", "給予回饋", ""], ["das Belastungserleben", "壓力感受", "-"], ["die Regenerationszeit", "恢復時間", "die Regenerationszeiten"], ["die Produktivität", "生產力", "-"], ["die Prävention", "預防", "-"]],
  },
  {
    titleZh: "社區節前的對話",
    ...
    extraVocab: [["die Migration", "移民", "-"], ["die Integration", "融入", "-"], ["die Partizipation", "參與", "-"], ["das Ehrenamt", "志工服務", "die Ehrenämter"], ["anregen", "提議；促成", ""], ["partizipativ", "參與式的", ""], ["niederschwellig", "低門檻的", ""], ["gesellschaftspolitisch", "社會政治性的", ""]],
  },
  {
    titleZh: "真假訊息工作坊",
    ...
    extraVocab: [["die Meldung", "消息", "die Meldungen"], ["viral gehen", "快速傳播", ""], ["nicht verifizierbar", "無法驗證的", ""], ["quellenkritisch", "來源批判的", ""], ["weiterverbreiten", "轉傳", ""], ["konzipieren", "設計；構思", ""], ["die Manipulation", "操控", "die Manipulationen"], ["die Glaubwürdigkeit", "可信度", "-"]],
  },
  {
    titleZh: "混合辦公實驗",
    ...
    vocab: [["der Arbeitsverbund", "工作協作體", "die Arbeitsverbünde"], ["die Beschlussfassung", "決策形成", "die Beschlussfassungen"], ["die Projektleiterin", "專案主管", "die Projektleiterinnen"], ["die Verantwortlichkeit", "職責", "die Verantwortlichkeiten"], ["die Erreichbarkeit", "可聯繫性", "-"], ["die Selbstorganisation", "自我管理", "-"], ["das Kontrollsystem", "管控制度", "die Kontrollsysteme"], ["die Vereinbarung", "協議", "die Vereinbarungen"], ["die Kommunikationskultur", "溝通文化", "die Kommunikationskulturen"], ["die Teamsitzung", "團隊會議", "die Teamsitzungen"], ["hybrid", "混合式的", ""], ["ressourcenschonend", "節省資源的", ""], ["innovationsfördernd", "促進創新的", ""], ["verbindlich", "具約束力的", ""], ["korrelieren", "相關", ""], ["zutage treten", "顯現", ""]],
    extraVocab: [["rigide", "僵化的", ""], ["nachvollziehbar", "可追溯理解的", ""], ["asynchron", "非同步的", ""], ["präsenznah", "接近實體互動的", ""], ["reibungslos funktionieren", "順利運作", ""], ["implementieren", "導入；實施", ""], ["die Dokumentation", "文件紀錄", "die Dokumentationen"], ["die Zuständigkeit", "權責", "die Zuständigkeiten"]],
  },
  {
    titleZh: "自動駕駛測試",
    ...
    vocab: [["die Forschungsgruppe", "研究團隊", "die Forschungsgruppen"], ["der Verkehrsträger", "交通載具", "die Verkehrsträger"], ["der Testkorridor", "測試路段", "die Testkorridore"], ["der Innenstadtrand", "市中心邊緣", "die Innenstadtränder"], ["die Steuerungstechnologie", "控制技術", "die Steuerungstechnologien"], ["der Schadensfall", "損害事件", "die Schadensfälle"], ["die Skepsis", "懷疑", "-"], ["die Sensorik", "感測系統", "-"], ["die Reaktionszeit", "反應時間", "die Reaktionszeiten"], ["die Innovation", "創新", "die Innovationen"], ["autonom", "自動自主的", ""], ["unvorhersehbar", "不可預見的", ""], ["haftungsrechtlich", "責任法上的", ""], ["vollumfänglich", "完整全面的", ""], ["haftbar sein", "負法律責任", ""], ["erläutern", "說明", ""]],
  ...
  },
  {
    ...
    extraVocab: [["umgangssprachlich", "口語化的", ""], ["adressatengerecht", "符合對象的", ""], ["den Eindruck erwecken", "造成……印象", ""], ["warnen vor", "警告不要", ""], ["zum Einsatz bringen", "使用；運用", ""], ["kooperativ", "合作式的", ""], ["die Fachsprache", "專業語言", "-"], ["die Ausdrucksweise", "表達方式", "die Ausdrucksweisen"]],
  },
  {
    titleZh: "考前論述日",
...
const b2ReadingExtensions = [
  "In der zweiten Runde vertiefen die Teilnehmenden die Argumente und beziehen auch Erfahrungen aus anderen Städten ein. Eine ältere Bewohnerin warnt davor, soziale Folgen nur in Zahlen zu messen. Ein Ladenbesitzer fordert dagegen verlässliche Lieferzonen und kurze Wege für Kundschaft. Die Moderatorin fasst die Gegensätze zusammen und bittet alle, zwischen kurzfristigem Nutzen und langfristiger Stadtqualität zu unterscheiden. Dadurch entsteht ein differenzierter Vorschlag, der ökologische, soziale und wirtschaftliche Aspekte miteinander verbindet.",
  "Anschließend vergleichen die Lernenden die Stellungnahme des Unternehmens mit den Erwartungen der Nutzerinnen und Nutzer. Sie prüfen, ob die Sprache Verantwortung übernimmt oder Probleme nur beschönigt. Besonders kritisch sehen sie unklare Formulierungen wie technische Schwierigkeiten und interne Prozesse. In Kleingruppen entwerfen sie Leitlinien für transparente Kommunikation nach digitalen Vorfällen. Dabei wird deutlich, dass Datenschutz nicht nur eine technische, sondern auch eine ethische Frage ist.",
  "In der Auswertung geht es nicht darum, perfekte Lösungen zu präsentieren, sondern Hindernisse realistisch zu beschreiben. Einige Lernende berichten, dass nachhaltige Produkte oft teurer oder schwerer erreichbar sind. Andere weisen darauf hin, dass politische Regeln und bessere Infrastruktur individuelles Verhalten erleichtern könnten. Die Klasse diskutiert deshalb, ob Konsumkritik allein genügt oder ob strukturelle Veränderungen nötig sind. Am Ende formuliert sie konkrete Empfehlungen für Schule, Supermärkte und Verbraucher.",
  "Im weiteren Gespräch erkennt Nora, dass beide Wege Risiken und Chancen enthalten. Ein Studium eröffnet theoretische Tiefe, verlangt aber oft viel Eigenorganisation und finanzielle Geduld. Eine Ausbildung bietet frühe Praxis, kann jedoch spätere Spezialisierungen begrenzen. Der Berater fordert Nora auf, Informationsquellen kritisch zu vergleichen und nicht nur auf Erwartungen ihrer Familie zu reagieren. Dadurch wird die Entscheidung zu einem Prozess, in dem persönliche Werte und berufliche Realität zusammengeführt werden.",
  "Die Lernenden lesen zusätzlich kurze Aussagen von Mieterinitiativen, Eigentümern und Stadtverwaltung. Jede Gruppe vertritt eine Perspektive und muss die Interessen der anderen nachvollziehbar zusammenfassen. Dabei merken sie, wie stark Sprache die Bewertung beeinflusst: Aufwertung klingt positiv, Verdrängung dagegen problematisch. In der Abschlussdiskussion entwickeln sie Kriterien für gerechte Stadtentwicklung. Wichtig sind nicht nur neue Gebäude, sondern auch soziale Stabilität, Beteiligung und langfristige Planung.",
  "Nach der Testphase werden die Ergebnisse genauer untersucht. Zwar sinken Krankmeldungen und Überstunden, doch einzelne Teams klagen über dichtere Arbeitsabläufe. Die Arbeitspsychologin betont, dass kürzere Arbeitszeit keine bloße Belohnung sein dürfe, sondern von klaren Prioritäten begleitet werden müsse. Die Lernenden diskutieren, ob Produktivität immer messbar ist und welche Rolle Erholung für kreative Arbeit spielt. So verbindet der Text persönliche Gesundheit mit organisatorischer Verantwortung.",
  "Während der Planung zeigt sich, dass kulturelle Vielfalt nicht automatisch zu echter Begegnung führt. Wenn Gruppen nur nebeneinander auftreten, bleibt der Austausch oberflächlich. Aylin schlägt deshalb Gesprächsregeln vor, die respektvolles Nachfragen ermöglichen. Andere ergänzen, dass auch Konflikte angesprochen werden dürfen, solange sie moderiert und fair bleiben. Die Klasse analysiert, wie gesellschaftliche Teilhabe praktisch gestaltet werden kann, ohne Unterschiede zu romantisieren oder Probleme zu vermeiden.",
  "Der Referent zeigt mehrere Beispiele, bei denen Bilder aus dem Zusammenhang gerissen wurden. Die Jugendlichen untersuchen, wie Emotionen Aufmerksamkeit erzeugen und gleichzeitig kritisches Denken schwächen können. Besonders wichtig ist die Frage, wer von einer Meldung profitiert und welche Quellen unabhängig bestätigt werden können. Danach formuliert die Gruppe Regeln für digitale Verantwortung im Alltag. Sie erkennt, dass Medienkompetenz nicht Misstrauen gegen alles bedeutet, sondern sorgfältiges Prüfen vor dem Teilen.",
  "Im weiteren Verlauf wird deutlich, dass hybrides Arbeiten nicht nur eine technische Frage ist. Wer selten im Büro ist, kann leichter übersehen werden oder informelle Informationen verpassen. Gleichzeitig ermöglicht das Modell mehr Flexibilität für Menschen mit langen Wegen oder familiären Aufgaben. Die Projektleiterin schlägt deshalb feste Austauschzeiten und transparente Entscheidungsprotokolle vor. Die Lernenden bewerten, welche Regeln Freiheit schützen und welche unnötige Kontrolle erzeugen würden.",
  "Die Forschungsgruppe veröffentlicht nach dem Test einen Bericht mit Chancen, Grenzen und offenen Fragen. Einige Bürgerinnen begrüßen die Technik, weil sie Mobilität im ländlichen Raum verbessern könnte. Andere befürchten, dass Verantwortung im Ernstfall zwischen Herstellern, Stadt und Softwarefirmen verschoben wird. Im Kurs wird diskutiert, ob Innovation gesellschaftliche Akzeptanz braucht, bevor sie im Alltag eingesetzt wird. Dadurch wird Technik nicht als neutral, sondern als politisch und rechtlich relevant verstanden.",
  "Bei der Überarbeitung erkennen die Lernenden, dass Nominalisierung nicht automatisch besseren Stil bedeutet. Ein Text kann zwar formeller wirken, aber gleichzeitig distanziert und schwer lesbar werden. Deshalb vergleichen sie zwei Versionen desselben Absatzes und entscheiden, welche für welchen Zweck geeigneter ist. Die Lehrerin zeigt, wie man abstrakte Nomen mit konkreten Beispielen verbindet. So entsteht ein Bericht, der präzise bleibt, ohne unnötig kompliziert zu klingen.",
  "Nach der Schreibphase erhalten die Lernenden Rückmeldungen zu Aufbau, Argumentationslogik und sprachlicher Genauigkeit. Besonders geübt wird, Gegenargumente nicht nur zu nennen, sondern fair einzuordnen und anschließend zu entkräften. Im mündlichen Teil müssen sie spontan reagieren, ohne die Struktur zu verlieren. Die Lehrerin erinnert daran, dass B2 nicht perfekte Fehlerfreiheit bedeutet, sondern differenziertes, zusammenhängendes und adressatengerechtes Kommunizieren.",
];
...
function getReadingExtension(level, lessonNumber) {
  if (level === "B1") return b1ReadingExtensions[lessonNumber - 1] || "";
  if (level === "B2") return b2ReadingExtensions[lessonNumber - 1] || "";
  return "";
}
